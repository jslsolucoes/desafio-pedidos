...
public class CriadorPedidoServiceTest extends AbstractTest {
	...
	when(cotacaoService.melhorCotacao(any(), anyInt())).thenThrow(new CotacaoServiceException("Alguma mensagem"));
	criadorPedidoService.criarNovosPedidos(Lists.newArrayList(new NovoPedido(produto, 1)));
    }
